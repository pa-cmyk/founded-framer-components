                ...
                <div>
                    ...
                    <div style={{ ...paramRowStyle, ...(isMobile ? { paddingTop: 0 } : { paddingTop: 0 }) }}>
                        ...
                        <div style={isMobile ? { ...paramCellStyle } : paramCellStyle}>
                            ...
                            >
                                <svg width="14" height="14" viewBox="0 0 256 256" fill="rgba(28,28,28,0.4)" style={{ flexShrink: 0, marginRight: 6, position: "relative" as const, top: 1 }}><path d="M146.34,98.34,164.69,80,146.34,61.66a8,8,0,0,1,11.32-11.32L176,68.69l18.34-18.35a8,8,0,0,1,11.32,11.32L187.32,80l18.34,18.34a8,8,0,0,1-11.32,11.32L176,91.31l-18.34,18.35a8,8,0,0,1-11.32-11.32Zm77.54,84.74A56.26,56.26,0,0,1,168,232C88.6,232,24,167.4,24,88A56.26,56.26,0,0,1,72.92,32.12a16,16,0,0,1,16.62,9.52l21.12,47.15,0,.12A16,16,0,0,1,109.39,104c-.18.27-.37.52-.57.77L88,129.45c7.49,15.22,23.41,31,38.83,38.51l24.34-20.71a8.12,8.12,0,0,1,.75-.56,16,16,0,0,1,15.17-1.4l.13.06,47.11,21.11A16,16,0,0,1,223.88,183.08Zm-15.88-2s-.07,0-.11,0h0l-47-21.05-24.35,20.71a8.44,8.44,0,0,1-.74.56,16,16,0,0,1-15.75,1.14c-18.73-9.05-37.4-27.58-46.46-46.11a16,16,0,0,1,1-15.7,6.13,6.13,0,0,1,.57-.77L96,95.15l-21-47a.61.61,0,0,1,0-.12A40.2,40.2,0,0,0,40,88,128.14,128.14,0,0,0,168,216,40.21,40.21,0,0,0,208,181.07Z"/></svg>{label2}
                            </div>
                            <PillSlider
                                value={missedRate}
                                min={minMissedRate}
                    ...
                    >
                        ...
                        <div style={paramCellStyle}>
                            ...
                            >
                                <svg width="14" height="14" viewBox="0 0 256 256" fill="rgba(28,28,28,0.4)" style={{ flexShrink: 0, marginRight: 6, position: "relative" as const, top: 1 }}><path d="M230.14,58.87A8,8,0,0,0,224,56H62.68L56.6,22.57A8,8,0,0,0,48.73,16H24a8,8,0,0,0,0,16h18L67.56,172.29a24,24,0,0,0,5.33,11.27,28,28,0,1,0,44.4,8.44h45.42A27.75,27.75,0,0,0,160,204a28,28,0,1,0,28-28H91.17a8,8,0,0,1-7.87-6.57L80.13,152h116a24,24,0,0,0,23.61-19.71l12.16-66.86A8,8,0,0,0,230.14,58.87ZM104,204a12,12,0,1,1-12-12A12,12,0,0,1,104,204Zm96,0a12,12,0,1,1-12-12A12,12,0,0,1,200,204Zm4-74.57A8,8,0,0,1,196.1,136H77.22L65.59,72H214.41Z"/></svg>{label3}
                            </div>
                            <div
                                style={{
                                    display: "flex",
                        ...
                        <div style={paramCellLastStyle}>
                            ...
                            >
                                <svg width="14" height="14" viewBox="0 0 256 256" fill="rgba(28,28,28,0.4)" style={{ flexShrink: 0, marginRight: 6, position: "relative" as const, top: 1 }}><path d="M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM72,48v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24V80H48V48ZM208,208H48V96H208V208Zm-38.34-85.66a8,8,0,0,1,0,11.32l-48,48a8,8,0,0,1-11.32,0l-24-24a8,8,0,0,1,11.32-11.32L116,164.69l42.34-42.35A8,8,0,0,1,169.66,122.34Z"/></svg>{label4}
                            </div>
                            <PillSlider
                                value={rdvRate}
                                min={minRdvRate}
                            ...
                            <div style={{ marginTop: isMobile ? 28 : 40 }}>
                                ...
                                >
                                    ...
                                    <div style={{ background: "rgba(255,58,58,0.05)", borderRadius: 16, padding: "28px 20px", textAlign: "center", display: "flex", flexDirection: "column" as const, alignItems: "center", gap: 8 }}>
                                        <svg width="28" height="28" viewBox="0 0 256 256" fill="rgba(255,58,58,0.5)"><path d="M184,89.57V84c0-25.08-37.83-44-88-44S8,58.92,8,84v40c0,20.89,26.25,37.49,64,42.46V172c0,25.08,37.83,44,88,44s88-18.92,88-44V132C248,111.3,222.58,94.68,184,89.57ZM232,132c0,13.22-30.79,28-72,28-3.73,0-7.43-.13-11.08-.37C170.49,151.77,184,139,184,124V105.74C213.87,110.19,232,122.27,232,132ZM72,150.25V126.46A183.74,183.74,0,0,0,96,128a183.74,183.74,0,0,0,24-1.54v23.79A163,163,0,0,1,96,152,163,163,0,0,1,72,150.25Zm96-40.32V124c0,8.39-12.41,17.4-32,22.87V123.5C148.91,120.37,159.84,115.71,168,109.93ZM96,56c41.21,0,72,14.78,72,28s-30.79,28-72,28S24,97.22,24,84,54.79,56,96,56ZM24,124V109.93c8.16,5.78,19.09,10.44,32,13.57v23.37C36.41,141.4,24,132.39,24,124Zm64,48v-4.17c2.63.1,5.29.17,8,.17,3.88,0,7.67-.13,11.39-.35A121.92,121.92,0,0,0,120,171.41v23.46C100.41,189.4,88,180.39,88,172Zm48,26.25V174.4a179.48,179.48,0,0,0,24,1.6,183.74,183.74,0,0,0,24-1.54v23.79a165.45,165.45,0,0,1-48,0Zm64-3.38V171.5c12.91-3.13,23.84-7.79,32-13.57V172C232,180.39,219.59,189.4,200,194.87Z"/></svg>
                                        <div style={{ fontSize: 32, fontWeight: 600, color: "#E53535", letterSpacing: "-0.03em", fontFamily: font }}>{formatFR(lostRevenueMonth)} €</div>
                                        <div style={{ fontSize: 13, color: "rgba(229,53,53,0.6)", lineHeight: 1.4 }}>manque à gagner / mois</div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div style={{ flex: 1, background: "rgba(255,58,58,0.05)", borderRadius: 16, padding: "24px 20px", textAlign: "center" }}>
                                        <div style={{ fontSize: 11, textTransform: "uppercase" as const, letterSpacing: "0.08em", color: "rgba(229,53,53,0.5)", marginBottom: 8, fontFamily: font }}>
                                            Vous perdez
                                        </div>
                                        <div style={{ fontSize: 32, fontWeight: 600, color: "#E53535", letterSpacing: "-0.03em", lineHeight: 1, fontFamily: font, marginBottom: 4 }}>
                                            {formatFR(lostRevenueMonth)} €
                                        </div>
                                        <div style={{ fontSize: 13, color: "rgba(229,53,53,0.45)" }}>par mois</div>
                                    </div>
                                </div>
